...
from web_learning_course.parse_config import parse_config
...
# Database
file_config = '/etc/django_web_learning_course.conf'
...
if not config:
    ...
    config = parse_config('market/django_web_learning_course.conf')
